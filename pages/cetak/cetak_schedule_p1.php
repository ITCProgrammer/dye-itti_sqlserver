...
$qTgl = sqlsrv_query(
  $con,
  "SELECT CONVERT(varchar(10), GETDATE(), 120) AS tgl_skrg,
...
<table width="100%" border="0">
    ...
    <tr>
      ...
      <td width="13%" rowspan="2" scope="col"><div align="center">Jenis Kain</div></td>
      <td width="9%" rowspan="2" scope="col"><div align="center">Warna</div></td>
      <td width="8%" rowspan="2" scope="col"><div align="center">No. Warna</div></td>
	...
	function tampil($mc, $no, $awal, $akhir){
		...
		if ($awal != "") {
			$sql .= " AND tgl_update BETWEEN ? AND ?";
			$params[] = $awal;
			$params[] = $akhir;
		}
		...
		$qCek = sqlsrv_query($con, $sql, $params);
...
LEFT JOIN tbl_mesin b ON a.no_mesin=b.no_mesin WHERE not a.`status`='selesai' GROUP BY a.no_mesin ORDER BY a.kapasitas DESC,a.no_mesin ASC"); */
		$data = sqlsrv_query(
			...
			"SELECT TOP 3 *
			 ...
			 ORDER BY kapasitas DESC, no_mesin ASC"
		);
	$no=1;
	$n=1;
	$c=0;
    ...
    <tr>
      ...
      <td valign="top"><div style="font-size: 8px;"><?php if(strlen($dd['jenis_kain'])>25){echo substr($dd['jenis_kain'],0,25)."...";}else{echo $dd['jenis_kain'];} ?></div></td>
      <td align="center" valign="top"><div style="font-size: 8px;"><?php if(strlen($dd['warna'])>25){echo substr($dd['warna'],0,25)."...";}else{echo $dd['warna'];} ?></div></td>
      ...
      <td align="center" valign="top"><?php if($dd['tgl_delivery']!="0000-00-00"){echo format_tanggal_sqlsrv($dd['tgl_delivery']);} ?></td>
    ...
    <tr>
      ...
      <td valign="top"><div style="font-size: 8px;"><?php if(strlen($dd1['jenis_kain'])>30){echo substr($dd1['jenis_kain'],0,30)."...";}else{echo $dd1['jenis_kain'];} ?></div></td>
      ...
      <td align="center" valign="top"><?php echo format_tanggal_sqlsrv($dd1['tgl_delivery']); ?></td>
    ...
    <tr>
      ...
      <td valign="top"><div style="font-size: 8px;"><?php if(strlen($dd2['jenis_kain'])>30){echo substr($dd2['jenis_kain'],0,30)."...";}else{echo $dd2['jenis_kain'];} ?></div></td>
      ...
      <td align="center" valign="top"><?php echo format_tanggal_sqlsrv($dd2['tgl_delivery']); ?></td>
    ...
    <tr>
      ...
      <td valign="top"><div style="font-size: 8px;"><?php if(strlen($dd3['jenis_kain'])>30){echo substr($dd3['jenis_kain'],0,30)."...";}else{echo $dd3['jenis_kain'];} ?></div></td>
      ...
      <td align="center" valign="top"><?php echo format_tanggal_sqlsrv($dd3['tgl_delivery']); ?></td>
    ...
    <tr>
      ...
      <td valign="top"><div style="font-size: 8px;"><?php if(strlen($dd4['jenis_kain'])>30){echo substr($dd4['jenis_kain'],0,30)."...";}else{echo $dd4['jenis_kain'];} ?></div></td>
      ...
      <td align="center" valign="top"><?php echo format_tanggal_sqlsrv($dd4['tgl_delivery']); ?></td>
    ...
    <tr>
      ...
      <td valign="top"><div style="font-size: 8px;"><?php if(strlen($dd5['jenis_kain'])>30){echo substr($dd5['jenis_kain'],0,30)."...";}else{echo $dd5['jenis_kain'];} ?></div></td>
      ...
      <td align="center" valign="top"><?php echo format_tanggal_sqlsrv($dd5['tgl_delivery']); ?></td>
    ...
    <tr>
      ...
      <td valign="top"><div style="font-size: 8px;"><?php if(strlen($dd6['jenis_kain'])>30){echo substr($dd6['jenis_kain'],0,30)."...";}else{echo $dd6['jenis_kain'];} ?></div></td>
      ...
      <td align="center" valign="top"><?php echo format_tanggal_sqlsrv($dd6['tgl_delivery']); ?></td>
...
<table width="100%" border="0">
  <tbody>
    <tr>
      <td width="87%" rowspan="4"><div style="font-size: 11px; font-family:sans-serif, Roman, serif;">
        <?Php
			$dtKet = sqlsrv_query(
				$con,
				"SELECT
					...
					SUM(CASE WHEN ket_status IN ('Greige','Salesmen Sample','Development Sample','Cuci Misty','Cuci YD') THEN 1 ELSE 0 END) AS greige
				FROM
					db_dying.tbl_schedule
				WHERE
					status <> 'selesai'"
		...
		Greige : <?php echo $rKet['greige']; ?> Lot<br />  
        Tolak Basah : <?php echo $rKet['tolak_basah']; ?> Lot
</div></td>
      <td width="13%"><pre>No. Form	: 14-11</pre></td>
    </tr>
    <tr>
      <td><pre>No. Revisi	: 16</pre></td>
    </tr>
    <tr>
      <td><pre>Tgl. Terbit	: 11 September 2020</pre></td>
    </tr>
    <tr>
      <td><pre>Halaman        : 1/16</pre></td>
    </tr>
  </tbody>
</table>	
<script>
