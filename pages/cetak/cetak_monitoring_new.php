...
<body>
  ...
  <table width="100%" border="" class="table-list1">
    ...
    <tr>
      ...
      <td colspan="2" style="border-left:0px #000000 solid;">: <?php echo $rowmt['no_hanger'];?></td>
      <td style="border-right:0px #000000 solid;">
        <pre>No. Mesin</pre>
      </td>
    ...
    <tr>
      ...
      <td colspan="4" style="border-left:0px #000000 solid;">:                                                               <?php echo $rowmt['lot']; ?> | LOT di ERP :<?php echo $d_lot['LOT'];?></td>
