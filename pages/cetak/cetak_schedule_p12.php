...
<title>Cetak Schedule Page 12</title>
<script>
...
LEFT JOIN tbl_mesin b ON a.no_mesin=b.no_mesin WHERE not a.`status`='selesai' GROUP BY a.no_mesin ORDER BY a.kapasitas DESC,a.no_mesin ASC"); */
	$data = sqlsrv_query(
		...
		"SELECT *
		 ...
		 OFFSET 43 ROWS FETCH NEXT 4 ROWS ONLY"
	);
	$no=1;
	$n=1;
	$c=0;
...
<table width="100%" border="0">
  <tbody>
    <tr>
      <td width="87%">&nbsp;</td>
      <td width="13%"><pre>No. Form	: 14-11</pre>        <pre>No. Revisi	: 15</pre>        <pre>Tgl. Terbit	: </pre>        <pre>Halaman        : 12/16</pre></td>
    </tr>
  </tbody>
</table>	
<script>
