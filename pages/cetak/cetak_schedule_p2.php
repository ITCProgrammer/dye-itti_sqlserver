...
<title>Cetak Schedule Page 2</title>
<script>
...
<table width="100%">
  ...
  <tr>
    ...
    <td width="91%" valign="middle" align="center"><strong><font size="+1" >SCHEDULE PENCELUPAN, RELAXING &amp; SCOURING&#10142;PRESET</font></strong></td>
    </tr>	
</table>
...
<table width="100%" border="0">
  <tbody>
    <tr>
      <td width="87%">&nbsp;</td>
      <td width="13%"><pre>No. Form	: 14-11</pre>        <pre>No. Revisi	: 15</pre>        <pre>Tgl. Terbit	: </pre>        <pre>Halaman        : 2/16</pre></td>
    </tr>
  </tbody>
</table>
<script>
