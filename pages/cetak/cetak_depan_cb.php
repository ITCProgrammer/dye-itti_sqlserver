...
<table width="100%" border="1" class="table-list1">
  <tr>
    ...
    <td width="56%" rowspan="3" valign="middle" align="center"><strong><font size="+1" >FORM TEMPELAN CONTINUOUS BLEACHING</font></strong></td>
...
$rpotb=sqlsrv_fetch_array($potb);?>      <?php if($rpotb['PONumber']!=""){echo strtoupper($rpotb['PONumber']);}else{ echo $rowsmp['po']; } ?></td>
  ...
  <tr>
    ...
    <td style="border-right: 0px;">Panjang Kain (m)</td>
    <td style="border-left: 0px;">: <?php echo $rowsmp1['pjng_kain'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top" style="border-right: 0px;">Lebar x Gramasi Out </td>
    <td valign="top" style="border-left: 0px;">: <?php echo $rowsmp1['lebar_s'];?> x <?php echo $rowsmp1['gramasi_s'];?></td> 
  ...
  <tr>
    ...
    <td align="left" valign="top" style="border-right: 0px;">Standar Cocok Warna</td>
    <td align="left" valign="top" style="border-left: 0px;">: <?php echo strtoupper($rowsmp1['std_cok_wrn']);?></td>
  </tr>
  <tr>
...
<table width="100%" border="1" class="table-list1">
  <tr align="center">
    <td colspan="4" ><strong>Setting Temperature (&deg;C)</strong></td>
  </tr>
  <tr >
    <td width="11%" style="border-right: 0px;">Scouring #1</td>
    <td width="40%" style="border-left: 0px;">: <?php echo $rowsmp1['sc1'];?></td>
    <td style="border-right: 0px;">Soaking</td>
    <td width="39%" style="border-left: 0px;">: <?php echo $rowsmp1['sk'];?></td>
  </tr>
  <tr >
    <td style="border-right: 0px;">Scouring #2</td>
    <td style="border-left: 0px;">: <?php echo $rowsmp1['sc2'];?></td>
    <td width="10%" style="border-right: 0px;">Steaming</td>
    <td style="border-left: 0px;">: <?php echo $rowsmp1['stm'];?></td>
  </tr>
  <tr >
    <td style="border-right: 0px;">Scouring #3</td>
    <td style="border-left: 0px;">: <?php echo $rowsmp1['sc3'];?></td>
    <td style="border-right: 0px;">Washing ABC</td>
    <td style="border-left: 0px;">: <?php echo $rowsmp1['ws_abc'];?></td>
  </tr>
  <tr >
    <td style="border-right: 0px;">Scouring #4</td>
    <td style="border-left: 0px;">: <?php echo $rowsmp1['sc4'];?></td>
    <td style="border-right: 0px;">Washing</td>
    <td style="border-left: 0px;">: <?php echo $rowsmp1['ws'];?></td>
  </tr>
  <tr >
    <td colspan="4" align="left" valign="top">Catatan : <span style="border-left: 0px;"><?php echo $rowsmp1['ket'];?></span></td>
  </tr>
</table>	
<table width="100%" border="1" class="table-list1">
  <tr align="center">
