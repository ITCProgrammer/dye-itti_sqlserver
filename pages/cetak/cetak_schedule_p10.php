...
<title>Cetak Schedule Page 10</title>
<script>
...
LEFT JOIN tbl_mesin b ON a.no_mesin=b.no_mesin WHERE not a.`status`='selesai' GROUP BY a.no_mesin ORDER BY a.kapasitas DESC,a.no_mesin ASC"); */
	$data = sqlsrv_query(
		$con,
		"SELECT b.* from db_dying.tbl_mesin b ORDER BY b.kapasitas DESC,b.no_mesin ASC OFFSET 35 ROWS FETCH NEXT 4 ROWS ONLY"
	);
	$no=1;
	$n=1;
	$c=0;
...
<table width="100%" border="0">
  <tbody>
    <tr>
      <td width="87%">&nbsp;</td>
      <td width="13%"><pre>No. Form	: 14-11</pre>        <pre>No. Revisi	: 15</pre>        <pre>Tgl. Terbit	: </pre>        <pre>Halaman        : 10/16</pre></td>
    </tr>
  </tbody>
</table>	
<script>
