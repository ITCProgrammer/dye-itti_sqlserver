...
<body>
	...
	/**
	 * Hitung total point per mesin (SQL Server).
	 */
	function Point($mc, $GShift1, $start_date1, $stop_date1)
	{
		...
		if ($GShift1 === 'ALL') {
			...
			$shft = " AND ISNULL(a.g_shift, c.g_shift) = '" . $GShift1 . "'";
		}

		// Filter tanggal + jam (konversi string ke datetime)
		$sql = "SELECT
			...
			WHERE
				b.no_mesin = '" . $mc . "'
				AND c.tgl_update IS NOT NULL
				AND c.tgl_update BETWEEN CONVERT(datetime, ?, 120) AND CONVERT(datetime, ?, 120)
				$shft
			GROUP BY b.no_mesin
			";

		$params = array($start_date1, $stop_date1);
		$qMC = sqlsrv_query($con, $sql, $params);
		...
		$point = isset($dMC['point']) ? (int)$dMC['point'] : 0;

		echo "<br><font size='+1' color='black'>" . $point . "</font>";
	}
	?>
	...
	<div class="box">
		...
		<form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
			...
			<div class="box-footer">
				<div class="col-sm-2">
					<button type="submit" class="btn btn-block btn-social btn-linkedin btn-sm" name="save" style="width: 60%"> Search <i class="fa fa-search"></i>
					</button>
				</div>
			</div>
		</form>
				...
				<div class="box-body">
					<table width="100%" border="2">
						<tbody>
							...
							<tr>
								<td align="center" bgcolor="#E0DDDD"><span class="btn btn-sm btn-success" id="35" data-toggle="tooltip" data-html="true" title="">35<b><?php echo Point("35", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#E0DDDD"><span class="btn btn-sm btn-success" id="01" data-toggle="tooltip" data-html="true" title="">01<b><?php echo Point("01", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#E0DDDD"><span class="btn btn-sm btn-success" id="17" data-toggle="tooltip" data-html="true" title="">17<b><?php echo Point("17", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="10" data-toggle="tooltip" data-html="true" title="">10<b><?php echo Point("10", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#ECE7E7">&nbsp;&nbsp;</td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="52" data-toggle="tooltip" data-html="true" title="">52<b><?php echo Point("52", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="63" data-toggle="tooltip" data-html="true" title="">63<b><?php echo Point("63", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="34" data-toggle="tooltip" data-html="true" title="">34<b><?php echo Point("34", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#ECE7E7">&nbsp;&nbsp;</td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="09" data-toggle="tooltip" data-html="true" title="">09<b><?php echo Point("09", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD"><span class="btn btn-sm btn-success" id="16" data-toggle="tooltip" data-html="true" title="">16<b><?php echo Point("16", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="32" data-toggle="tooltip" data-html="true" title="">32<b><?php echo Point("32", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#ECE7E7"><span class="btn btn-sm btn-success" id="40" data-toggle="tooltip" data-html="true" title="">40<b><?php echo Point("40", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="66" data-toggle="tooltip" data-html="true" title="">66<b><?php echo Point("66", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="67" data-toggle="tooltip" data-html="true" title="">67<b><?php echo Point("67", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="03" data-toggle="tooltip" data-html="true" title="">03<b><?php echo Point("03", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="07" data-toggle="tooltip" data-html="true" title="">07<b><?php echo Point("07", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD"><span class="btn btn-sm btn-success" id="64" data-toggle="tooltip" data-html="true" title="">64<b><?php echo Point("64", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#E0DDDD">&nbsp;</td>
								<td align="center" bgcolor="#ECE7E7"><span class="btn btn-sm btn-success" id="21" data-toggle="tooltip" data-html="true" title="">21<b><?php echo Point("21", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#ECE7E7"><span class="btn btn-sm btn-success" id="31" data-toggle="tooltip" data-html="true" title="">31<b><?php echo Point("31", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="22" data-toggle="tooltip" data-html="true" title="">22<b><?php echo Point("22", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="49" data-toggle="tooltip" data-html="true" title="">49<b><?php echo Point("49", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="23" data-toggle="tooltip" data-html="true" title="">23<b><?php echo Point("23", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="27" data-toggle="tooltip" data-html="true" title="">27<b><?php echo Point("27", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="53" data-toggle="tooltip" data-html="true" title="">53<b><?php echo Point("53", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD">&nbsp;&nbsp;</td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="43" data-toggle="tooltip" data-html="true" title="">43<b><?php echo Point("43", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm btn-success" id="56" data-toggle="tooltip" data-html="true" title="">56<b><?php echo Point("56", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD"> <span class="btn btn-sm btn-success" id="59" data-toggle="tooltip" data-html="true" title="">59<b><?php echo Point("59", $GShift, $start_date, $stop_date); ?></b></span> </td>
								<td align="center" bgcolor="#E0DDDD">&nbsp;</td>
								<td align="center" bgcolor="#ECE7E7"> <span class="btn btn-sm  btn-success" id="WS" data-toggle="tooltip" data-html="true" title="">WS<b><?php echo Point("WS", $GShift, $start_date, $stop_date); ?></b></span> </td>
							</tr>
							<tr>
								<td align="center" bgcolor="#E0DDDD"><span class="btn btn-sm btn-success" id="37" data-toggle="tooltip" data-html="true" title="">37<b><?php echo Point("37", $GShift, $start_date, $stop_date); ?></b></span></td>
								...
								<td align="center" bgcolor="#E0DDDD"><span class="btn btn-sm btn-success" id="30" data-toggle="tooltip" data-html="true" title="">30<b><?php echo Point("30", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#ECE7E7">&nbsp;</td>
								<td align="center" bgcolor="#ECE7E7">&nbsp;</td>
								...
								<td align="center" bgcolor="#E0DDDD">&nbsp;</td>
								<td align="center" bgcolor="#ECE7E7"><span class="btn btn-sm btn-success" id="47" data-toggle="tooltip" data-html="true" title="">47<b><?php echo Point("47", $GShift, $start_date, $stop_date); ?></b></span></td>
								<td align="center" bgcolor="#E0DDDD">&nbsp;</td>
								<td align="center" bgcolor="#E0DDDD">&nbsp;</td>
	...
	<div id="EditStsCelup" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
	<script>
